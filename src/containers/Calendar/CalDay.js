  ...
  return (
    <div>
      <Modal
        ...
        trigger={
          <Col s={1} className={`list-group-item ${availability}`} id={date}>
            {date}
          </Col>
        }
      >
        <form className="col s12 form center-align" id={"edit-form"}>
          ...
          <Row>
            <Button
              className="modal-close waves-effect waves-light btn-large button-color"
              id="editSubmit"
              onSubmit={onSubmit}
            >
              Submit
